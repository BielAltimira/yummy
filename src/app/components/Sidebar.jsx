...
export default function Sidebar({ setCurrentTab }) {
    return <aside className="w-72 h-100% mt-8 bg-slate-950 flex flex-col align-center px-8 py-16 rounded-tr-xl shadow-2xl ">
            <Image priority src="/assets/yummy.png" width={200} height={400} alt="logo"></Image>
            <h2 className="mb-8 font-bold font-mono text-center text-2xl md:text-4xl text-stone-200 ">Yumi</h2>
